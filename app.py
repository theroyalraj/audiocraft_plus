...
def load_model(version='facebook/musicgen-melody', custom_model=None, gen_type="music"):
    global MODEL, MODELS
    ...
    if MODELS is None:
        ...
        if MODEL is not None:
            ...
            t1 = time.monotonic()
        if version != 'facebook/musicgen-custom' and MODELS.get(version) is None:
